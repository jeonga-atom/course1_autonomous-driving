...
YAW_GENTLE_CALL                 = 0.25      # [rad/s] 약한 회전
YAW_STRONG_CALL                 = 0.60      # [rad/s] 강한 회전

THR_NEAR_CALL                   = 0.7       # [m] (설정 값) 이내 → 약하게 반대편/ 대회에서는 0.8정도..?
THR_VERY_NEAR_CALL              = 0.5       # [m] (설정 값) 이내 → 강하게 반대편/ 대회에서는 0.5정도..?
...
class CorridorNavigator(Node):
    def __init__(self):
        ...
        self.declare_parameter('front_rearm_dist', FRONT_REARM_DIST)     
        self.declare_parameter('turn_cooldown_sec', TURN_COOLDOWN_SEC)     
        ...
        # 주행 속도 및 회전량 (필요 시 조정)
        self.LIN_SPEED          = LINE_SPEED_CALL
        self.YAW_GENTLE         = YAW_GENTLE_CALL
        self.YAW_STRONG         = YAW_STRONG_CALL
        # 임계값 (요청 조건)
        self.THR_NEAR           = THR_NEAR_CALL  
        self.THR_VERY_NEAR      = THR_VERY_NEAR_CALL
        # 제어 주기 (컨트롤 루프)
        self.CTRL_HZ            = CTRL_HZ_CALL
        ...
        self.drive_out_sec      = DRIVE_OUT_SEC_CALL
